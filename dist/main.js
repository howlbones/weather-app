...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main.css */ \"./src/main.css\");\n/* harmony import */ var _fetchData__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fetchData */ \"./src/fetchData.js\");\n\n\n(async function app() {\n  const searchRequest = 'saint-petersburg';\n  const searchResult = await (0,_fetchData__WEBPACK_IMPORTED_MODULE_1__.fetchData)('search', searchRequest).then(result => {\n    console.log('Got search data:');\n    console.log(result[0].url);\n    console.log(result);\n    console.log('\\n');\n    return result;\n  });\n  const weatherData = await (0,_fetchData__WEBPACK_IMPORTED_MODULE_1__.fetchData)('forecast', await searchResult[0].url).then(responce => {\n    console.log('Got forecast data:');\n    console.log(responce);\n    console.log('\\n');\n    return responce;\n  });\n})();\n\n//# sourceURL=webpack://weather-app/./src/index.js?");
